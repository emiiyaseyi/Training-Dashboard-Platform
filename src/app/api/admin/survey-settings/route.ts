...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    customSurveyMirrorSheetName: settings?.customSurveyMirrorSheetName || '',
    customSurveyMirrorStatus: settings?.customSurveyMirrorStatus || null,
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const data = {
      ...
      customSurveyMirrorSheetName: body.customSurveyMirrorSheetName || null,
